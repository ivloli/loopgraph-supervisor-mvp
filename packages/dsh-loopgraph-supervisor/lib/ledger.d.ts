...
export declare function initialState(workflowId: string, goal: string, maxAttempts: number, acceptance: LoopState['acceptance'], loopSpec?: import("./loopspec.js").LoopSpec): LoopState;
